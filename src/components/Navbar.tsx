      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {!isLoggedIn && <Button onClick={() => setShowLoginDialog(true)} variant="default" size="sm" className="bg-gradient-to-r from-[#D946EF] to-[#0EA5E9] hover:opacity-90 text-white font-medium rounded-full px-4 shadow-md transition-all duration-300 flex items-center">
